            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                    ...
                    <div className="sm:col-span-12 lg:col-span-3">
                        <div className="mb-2">
                            {/* Logo */}
                            <Link href="/" className="inline-block" aria-label="WebTemplate">
                            ...
                            <div className="flex flex-wrap mb-4">
                                <div className="w-full">
                                    ...
                                    <div className="relative flex items-center max-w-xs">
                                        <input id="newsletter" type="email" className="outline-none form-input w-full text-gray-800 px-3 py-2 pr-12 text-sm" placeholder="Your email" required />
                ...
                <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
                    ...
                    {/* Copyrights note */}
                    <div className="text-sm text-gray-600 mr-4">&copy; web_template.local. All rights reserved.</div>
